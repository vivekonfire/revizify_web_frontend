...
const CourseDetails = ({ cards_ }) => {
  ...
  useEffect(() => {
    if (router.query.id !== undefined) {
      ...
      dispatch(getCards({ "course_id": router.query.id }));
    }
  }, [router.query.id]);
    ...
    <div className="leave_navbar min-vh-100 text-white  gap-5 mx-5 row">
      ...
      <div className="col-xl-7 col-12 me-5 text-white">
        ...
        <div className="d-flex flex-row">
          {card?.video ? <iframe src={card.video} alt="Video image" className="w-100 border rounded " allow="fullscreen" height={"450vh"} /> : <Image src={Video}/> }
          
          <div className="d-flex flex-column justify-content-center gap-4 m-3">
            <div
